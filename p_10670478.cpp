...
{ public:
 ...
 while(p<=100)
     {
cout<<"Enter 1 if you are a student.\n";
cout<<"Enter 2 if you are a staff.\n";
cin>>intro;
if(intro=="1")
 {   while(stdMenu<=10)
     {system("color 5C");
  ...
  if(stdIntro=="1")
    ...
    cout<<"For instance, the first student you create will be referred to as\n";
    cout<<"Student 1\n";
    ...
    if((k.sex[i-1])=="m"||(k.sex[i-1])=="M")
        ...
        k.sex[i-1]="FEMALE";
    cout<<"How many courses will "<<k.name[i-1]<<" be offering this semester?(maximum is 7)\n";
    cin>>cNo[i-1];
           ...
           { system("cls");
             ...
             {  while (eSLoop<=10)
                   ...
                   { system("cls");
                    ...
                    cout<<"(Correcting any mistakes you had made earlier\n)";
                    cout<<"How many courses will "<<k.name[editS-1]<<" be offering this semester?(maximum is 7)\n";
    cin>>cNo[i-1];
    cout<<"Enter the course codes(after each course, press the enter key)\n";
    for(r=0;r<cNo[i-1];r++)
    ...
    for(r=0;r<t.CNum[i-1];r++)
      ...
      break;
          ...
          x++;
            ...
            { while(e<=10)
          { system("cls");
           cout<<"Enter the number of the students whose records you want to delete( e.g.enter 1 for student 1 and so on....)\n";
           cin>>del;
           t.FName[del-1]=" ";
           t.LName[del-1]=" ";
           t.ID[del-1]=" ";
           ...
           while(h<=10)
                {
            cout<<"Enter the number of the staff members whose details you want to print\n";
            cin>>print;
           system("cls");
